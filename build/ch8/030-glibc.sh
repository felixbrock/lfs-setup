#!/bin/bash
# Generated from LFS 13.0-systemd chapter 8 (glibc) — runs inside chroot
# Included book blocks: [0, 1, 2, 3, 4, 5, 7, 8, 12, 13, 14, 15, 17, 18, 20, 21, 22] of 23; tolerant: [5]
set -euo pipefail
cd /sources
rm -rf glibc-2.43
...
# 2026-07-13: consolidated security patch per advisories 13.0-021/067
# (DNS validation + three code-execution CVEs), as applied by the
# development book. sha256 in the batch commit.
