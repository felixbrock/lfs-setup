#!/bin/bash
# Runs all Gate C package builds INSIDE the LFS chroot, logging each and
...
DIR=/sources/gatec-scripts
LOGDIR=/sources/logs/gatec
...
echo "=== Gate C batches 1-6 complete ==="
